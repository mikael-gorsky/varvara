    ...
    Tables: {
      ...
      ozon_data: {
        Row: {
          ...
          ordered_sum: number | null;
          turnover_dynamic: number | null;
          ordered_quantity: number | null;
          average_price: number | null;
          minimum_price: number | null;
          buyout_share: number | null;
          lost_sales: number | null;
          days_no_stock: number | null;
          average_delivery_hours: number | null;
          average_daily_revenue: number | null;
          average_daily_sales_pcs: number | null;
          ending_stock: number | null;
          work_scheme: string | null;
          volume_liters: number | null;
          views: number | null;
          views_search: number | null;
          views_card: number | null;
          view_to_cart: number | null;
          search_to_cart: number | null;
          description_to_cart: number | null;
          discount_promo: number | null;
          revenue_promo: number | null;
          days_promo: number | null;
          days_boost: number | null;

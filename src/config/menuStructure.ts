...
export const menuStructure: MenuStructure = {
  ...
  l2Items: {
    ...
    IMPORT: ['IMPORT SALES-MARGIN REPORT', 'IMPORT INVENTORY FILES', 'IMPORT OZON REPORTS', 'IMPORT WB REPORTS', 'IMPORT YANDEX.MARKET REPORTS', 'IMPORT OUR PRICE-LIST'],
  ...
  tileGroups: {
    ...
    IMPORT: [
      ...
      { category: 'INVENTORY', items: ['IMPORT INVENTORY FILES'] },
